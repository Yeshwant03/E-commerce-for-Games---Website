			...
			<div class="row">
				<div class="span4">
					<form method="POST" class="search_form">
						<input type="text" class="input-block-level search-query" Placeholder="eg. GTA V">
					</form>
				</div>
				<div class="span8">
		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu" >
				<div class="navbar-inner main-menu">				
					<a href="home.html" class="logo pull-left"><img src="themes/images/logo.png" class="site_logo" alt=""></a>
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./home.html">Home</a>	
							<li><a href="./products.html">Library</a>					
								<ul>
									<li><a href="./products.html">Action</a></li>									
									<li><a href="./products1.html">Role-Playing</a></li>
									<li><a href="./products2.html">Sports</a></li>									
								</ul>
							</li>
							<!--																		
							<li><a href="./products.html">Consoles</a>
								<ul>									
									<li><a href="./products.html">PS4</a></li>
									<li><a href="./products.html">XBOX</a></li>
									<li><a href="./products.html">XXXXX</a></li>
								</ul>
							</li>	
							-->						
			...
			<img class="pageBanner" src="themes/images/newPageBanner.jpeg" alt="New products" >
				...
				<div class="row">						
					<div class="span9">
						<div class="row">
							...
							$int = (int)$data1;
							$sql = "SELECT name, id, price FROM action where id=$int";
							$result = $conn->query($sql);
							...
							if ($result->num_rows > 0) {
							     ...
							     while($row = $result->fetch_assoc()) {
							         ...
							         echo "<br> <strong> Availability: </strong> In Stock ";
							         echo "<br> <h4><strong> Price: Rs ". $row["price"].  "</strong></h4>";
							         //echo "<img src='themes/images/ladies/1.jpg'";
							...
							<div class="span5">
								<form class="form-inline" action="script.php" method="post">
									<label>Qty:</label>
									<input type="text" class="span1" placeholder="1" name="quant">
							...
							// Check connection
									...
									<button class="btn btn-inverse" type="submit" >Buy now</button><br><br><br><br>
								</form>
							</div>	
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									...
									$int = (int)$data1;
									$sql = "SELECT description FROM action where id=$data1";
									$result = $conn->query($sql);
				...
				<div class="row">
					<div class="span3">
						...
						<ul class="nav">
							...
							<li><a href="./products.html">Library</a></li>
							<li><a href="./top_sellers.html">Top Sellers</a></li>
